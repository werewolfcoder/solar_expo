...
camera.position.z = 5; // Pull the camera back a bit, if not you cannot see
scene.add(camera);
...
const particleTexture = textureLoader.load('./public/skybox/stars_twinkle.png'); // Add a texture to the particles
